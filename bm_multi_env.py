...
img_i = convert_to_rgba(mpimg.imread(IMAGE_DIR + 'i.png'))
img_b = convert_to_rgba(mpimg.imread(IMAGE_DIR + 'b.png'))
img_m = convert_to_rgba(mpimg.imread(IMAGE_DIR + 'm.png'))
...
'''
    ...
    def render(self, graphical=True):
        ...
        if graphical:
            ...
            map_rows.append(np.concatenate((mid_wall,img_i,img_b,img_m,mid_wall),axis=1))
